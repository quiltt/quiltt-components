...
export type SourceTransactions = PlaidTransaction | SpadeTransaction
...
export type BillsQuery = {
  ...
  recurrences?: Maybe<
    Array<{
      ...
      frequency: RecurrenceFrequency
      state: LedgerState
      transactionNext?: Maybe<{ __typename?: 'Transaction'; id: string; date: any; amount: number }>
    }>
  >
}
...
export type BillTemplateQuery = {
  __typename?: 'Query'
  recurrences?: Maybe<Array<{ __typename?: 'Recurrence'; name?: Maybe<string> }>>
}
...
export type CreateBillMutation = {
  ...
  recurrenceCreate?: Maybe<{
    ...
    errors?: Maybe<
      Array<{ __typename?: 'Error'; message?: Maybe<string>; path?: Maybe<Array<string>> }>
    >
  }>
}
...
export type NextPaycheckQueryQuery = {
  __typename?: 'Query'
  profile?: Maybe<{ __typename?: 'Profile'; name?: Maybe<string> }>
}
...
export type RoundUpActivateMutation = {
  ...
  roundUpSetStartTime?: Maybe<{
    ...
    record?: Maybe<{
      __typename?: 'RoundUp'
      id: string
      balance: { __typename?: 'LedgerBalance'; id: string; available?: Maybe<number> }
...
export type RoundUpsBankConnectionsAccountsListQuery = {
  ...
  roundUp?: Maybe<{
    ...
    fundingAccount?: Maybe<{
      __typename?: 'Account'
      id: string
      balance: { __typename?: 'LedgerBalance'; current?: Maybe<number> }
    }>
  }>
  plaidItem?: Maybe<{
    __typename?: 'PlaidItem'
    ...
    status: PlaidItemStatus
    syncedAt?: Maybe<any>
    logo?: Maybe<{ __typename?: 'Image'; url?: Maybe<any> }>
...
export type RoundUpsBankConnectionsAddFundingMutation = {
  ...
  roundUpSetFundingAccount?: Maybe<{
    __typename?: 'RoundUpSetFundingAccountPayload'
    success: boolean
    record?: Maybe<{ __typename?: 'RoundUp'; id: string }>
  }>
  roundUpSubscribedAccountsAdd?: Maybe<{
    __typename?: 'RoundUpSubscribedAccountsAddPayload'
    success: boolean
...
export type RoundUpsRecentActivityQuery = {
  ...
  roundUp?: Maybe<{
    __typename?: 'RoundUp'
    id: string
    recentActivity: { __typename?: 'LedgerBalance'; id: string; current?: Maybe<number> }
  }>
}
...
export type RoundUpsBankConnectionsSummaryCardHeaderQuery = {
  __typename?: 'Query'
  plaidItems?: Maybe<Array<{ __typename?: 'PlaidItem'; id: string }>>
}
...
export type RoundUpsBankConnectionsCardQuery = {
  __typename?: 'Query'
  roundUp?: Maybe<{ __typename?: 'RoundUp'; id: string }>
  plaidItem?: Maybe<{
    __typename?: 'PlaidItem'
    id: string
    name: string
...
export type RoundUpsBankConnectionsListQuery = {
  ...
  roundUp?: Maybe<{
    ...
    fundingAccount?: Maybe<{
      ...
      type: AccountType
      balance: { __typename?: 'LedgerBalance'; current?: Maybe<number> }
      plaidItem?: Maybe<{ __typename?: 'PlaidItem'; id: string }>
    }>
  }>
  plaidItems?: Maybe<
    Array<{
...
export type RoundUpsPauseMutation = {
  ...
  roundUpPause?: Maybe<{
    __typename?: 'RoundUpPausePayload'
    record?: Maybe<{ __typename?: 'RoundUp'; id: string; status: LedgerStatus }>
  }>
}
...
export type RoundUpHistoryQuery = {
  ...
  roundUp?: Maybe<{
    __typename?: 'RoundUp'
    id: string
    day0: { __typename?: 'LedgerBalance'; id: string; available?: Maybe<number> }
    day1: { __typename?: 'LedgerBalance'; id: string; available?: Maybe<number> }
    day2: { __typename?: 'LedgerBalance'; id: string; available?: Maybe<number> }
    day3: { __typename?: 'LedgerBalance'; id: string; available?: Maybe<number> }
    day4: { __typename?: 'LedgerBalance'; id: string; available?: Maybe<number> }
    day5: { __typename?: 'LedgerBalance'; id: string; available?: Maybe<number> }
    day6: { __typename?: 'LedgerBalance'; id: string; available?: Maybe<number> }
  }>
}
...
export type RoundUpsQuery = {
  __typename?: 'Query'
  roundUps?: Maybe<Array<{ __typename?: 'RoundUp'; id: string }>>
}
...
export type PlaidLinkTokenCreateMutation = {
  ...
  plaidLinkTokenCreate?: Maybe<{
    __typename?: 'PlaidLinkTokenCreatePayload'
    record?: Maybe<{ __typename?: 'PlaidLinkToken'; linkToken: string; expiration: any }>
    errors?: Maybe<
      Array<{
        __typename?: 'PlaidAPIError'
        code: string
...
export type PlaidItemCreateMutation = {
  ...
  plaidItemCreate?: Maybe<{
    ...
    errors?: Maybe<Array<{ __typename?: 'PlaidAPIError'; displayMessage?: Maybe<string> }>>
  }>
}
...
export type PlaidItemUnlinkMutation = {
  ...
  plaidItemDelete?: Maybe<{
    __typename?: 'PlaidItemDeletePayload'
    success: boolean
    record?: Maybe<{ __typename?: 'PlaidItem'; id: string }>
  }>
}
...
export type ProfileUpdateMutation = {
  ...
  profileUpdate?: Maybe<{
    ...
    errors?: Maybe<
      Array<{ __typename?: 'Error'; path?: Maybe<Array<string>>; message?: Maybe<string> }>
    >
  }>
}
